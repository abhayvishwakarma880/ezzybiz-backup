        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-5 md:px-8">
          ...
          > 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button onClick={() => window.dispatchEvent(new CustomEvent("open-lead-modal", { detail: { service: "Ras Al Khaimah Free Zone Company Setup" } }))} className="flex items-center justify-center gap-2 border border-white/30 bg-white/10 text-white px-7 py-3 rounded-lg text-sm font-semibold tracking-wide transition-all duration-300 hover:border-[#d7193f] hover:text-white hover:shadow-md no-underline">
